...
namespace CmfDemo.Migrations
{
    ...
    [Migration("20251028190620_update_entity_type")]
    partial class update_entity_type
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CmfDemo.Data.EntityType1", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("EntityType1s");
                });

            modelBuilder.Entity("CmfDemo.Data.EntityType2", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("EntityType1Id");

                    b.ToTable("EntityType2s");
                });
            ...
            modelBuilder.Entity("CmfDemo.Data.EntityType2", b =>
                {
                    b.HasOne("CmfDemo.Data.EntityType1", "EntityType1Entity")
                        .WithMany("EntityType2s")
                        .HasForeignKey("EntityType1Id");

                    b.Navigation("EntityType1Entity");
                });
